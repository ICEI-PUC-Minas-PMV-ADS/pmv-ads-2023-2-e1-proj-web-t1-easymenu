...
O acesso a tela de login poderá ser feito atráves da opção de menu "Login" e a de cadastro poderá ser feito através da opção "Registre-se". As estruturas de dados foram baseadas em HTML, CSS e JS.
